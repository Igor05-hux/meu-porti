...
// Botão "Falar comigo" (hero) -> WhatsApp direto
const talkBtn = document.getElementById("talkBtn");
if (talkBtn) {
  const msg = "Olá! Vi seu site e queria falar com você.";
  talkBtn.href = `https://wa.me/${WHATS_NUMBER}?text=${encodeURIComponent(msg)}`;
}
